...
class HistoryBaseController extends GetxController {
  ...
  void onClearHistory(BuildContext context, VoidCallback onSuccess) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        title: Text('提示'.tr),
        content: Text('啊叻？你要清空历史记录功能吗？'.tr),
        actions: [
          TextButton(
            onPressed: Get.back,
            child: Text(
          ...
          TextButton(
            onPressed: () async {
              ...
              SmartDialog.dismiss();
              if (res.isSuccess) {
                SmartDialog.showToast('清空观看历史'.tr);
                onSuccess();
              } else {
                res.toast();
              }
  ...
  void onPauseHistory(BuildContext context) {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        title: Text('提示'.tr),
        content: Text(pauseStatus ? '啊叻？你要暂停历史记录功能吗？'.tr : '啊叻？要恢复历史记录功能吗？'.tr),
        actions: [
          TextButton(
            onPressed: Get.back,
            child: Text(
          ...
          TextButton(
            onPressed: () async {
              ...
              SmartDialog.dismiss();
              if (res.isSuccess) {
                SmartDialog.showToast(pauseStatus ? '暂停观看历史'.tr : '恢复观看历史'.tr);
            ...
            child: Text(pauseStatus ? '确认暂停'.tr : '确认恢复'.tr),
          ),
        ],
      ),
    );
