...
List<SettingsModel> get extraSettings => [
  ...
  NormalModel(
    ...
    getSubtitle: () => '配置 OpenAI 兼容 API 和提示词模板'.tr,
    onTap: (context, _) => Get.toNamed('/aiSetting'),
  ),
  SplitModel(
    normalModel: NormalModel.split(
      title: '检查未读动态'.tr,
      subtitle: '点击设置检查周期(min)'.tr,
  ...
  SwitchModel(
    title: '评论点赞/点踩按钮交换位置'.tr,
    subtitle: '交换后：点赞在左，点踩在右（与官方客户端一致）'.tr,
  ...
  SwitchModel(
    title: '分P/合集：倒序播放从首集开始播放'.tr,
    subtitle: '开启则自动切换为倒序首集，否则保持当前集'.tr,
    leading: Icon(MdiIcons.sort),
    setKey: SettingBoxKey.reverseFromFirst,
    defaultVal: true,
  ),
  SwitchModel(
    title: '禁用 SSL 证书验证'.tr,
    subtitle: '谨慎开启，禁用容易受到中间人攻击'.tr,
  ...
  NormalModel(
    ...
    getSubtitle: () => '关键词、用户屏蔽、等级过滤、屏蔽带货评论'.tr,
    onTap: (context, _) => Get.to(() => const ReplySetting()),
  ),
  SwitchModel(
    title: '使用外部浏览器打开链接'.tr,
    leading: Icon(Icons.open_in_browser),
    setKey: SettingBoxKey.openInBrowser,
    defaultVal: false,
  ),
  SwitchModel(
    title: '点击当前页时回顶并刷新'.tr,
    subtitle: '关闭后保持原有回顶/重复点击刷新行为'.tr,
  ...
  NormalModel(
    ...
    getSubtitle: () {
      ...
      if (!enabled) return '已关闭'.tr;
      final window = Pref.mergeDanmakuWindowSeconds;
      final crossMode = Pref.mergeDanmakuCrossMode ? '跨类型'.tr : '同类型'.tr;
  ...
  SwitchModel(
    title: '显示视频推荐理由'.tr,
    subtitle: '显示首页视频卡片下方的已关注，x万点赞的标签'.tr,
    leading: Icon(Icons.label_outline),
    setKey: SettingBoxKey.showRcmdReason,
    defaultVal: true,
  ),
  SwitchModel(
    title: '预览 Live Photo'.tr,
    subtitle: '开启则以视频形式预览 Live Photo，否则预览静态图片'.tr,
  ...
  SwitchModel(
    ...
    title: '震动反馈'.tr,
    subtitle: '请确定手机设置中已开启震动反馈'.tr,
  ),
  SwitchModel(
    title: '大家都在搜'.tr,
    subtitle: '是否展示「大家都在搜」'.tr,
  ...
  SwitchModel(
    title: '启用AI总结'.tr,
    subtitle: '视频详情页开启AI总结'.tr,
    leading: Icon(Icons.engineering_outlined),
    setKey: SettingBoxKey.enableAi,
    defaultVal: false,
  ),
  SwitchModel(
    title: '消息页禁用"收到的赞"功能'.tr,
    subtitle: '禁止打开入口，降低网络社交依赖'.tr,
  ...
  SwitchModel(
    title: '默认展示评论区'.tr,
    subtitle: '在视频详情页默认切换至评论区页（仅Tab型布局）'.tr,
  ...
  SwitchModel(
    title: '显示动态互动内容'.tr,
    subtitle: '开启后则在动态卡片底部显示互动内容（如关注的人点赞、热评等）'.tr,
  ...
  SwitchModel(
    title: '检测预发布版本更新'.tr,
    subtitle: '检查更新时同时包含 pre-release 版本'.tr,
    leading: Icon(Icons.preview_outlined),
  ...
  final res = await showDialog<String>(
    ...
    builder: (context) {
      ...
      return SelectDialog<String>(
        title: fallback ? '服务器无loudnorm配置时使用'.tr : '音量均衡'.tr,
        toggleable: true,
      ...
      await showDialog(
        ...
        builder: (context) => AlertDialog(
          ...
          content: Column(
            ...
            spacing: 16,
            children: [
              Text('等同于 --lavfi-complex="[aid1] 参数 [ao]"'.tr),
              TextField(
                autofocus: true,
    ...
    builder: (context) => SimpleDialog(
      ...
      children: [
        DialogOption(
          ...
          child: Text('复制'.tr, style: TextStyle(fontSize: 14)),
        ),
        DialogOption(
          onPressed: () {
            Get.back();
          ...
          child: Text('重置'.tr, style: TextStyle(fontSize: 14)),
        ),
        DialogOption(
          onPressed: () async {
            Get.back();
          ...
          child: Text('设置新路径'.tr, style: TextStyle(fontSize: 14)),
        ),
      ],
    ),
  );
  ...
  showDialog(
    ...
    builder: (context) => AlertDialog(
      ...
      content: TextFormField(
        ...
        inputFormatters: [FilteringTextInputFormatter.digitsOnly],
        decoration: InputDecoration(suffixText: '行'.tr),
      ),
      actions: [
        TextButton(
          onPressed: Get.back,
