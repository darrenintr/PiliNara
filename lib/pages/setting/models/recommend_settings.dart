...
List<SettingsModel> get recommendSettings => [
  ...
  SwitchModel(
    title: '显示上次看到位置提示'.tr,
    subtitle: '保留上次推荐时，在上次刷新位置显示提示'.tr,
  ...
  getListBanWordModel(
    title: 'App推荐/热门/排行榜: 视频分区关键词过滤'.tr,
  ...
  NormalModel(
    ...
    getSubtitle: () => Pref.rcmdMode != RcmdMode.web
        ? '仅对首页 app 端推荐生效，屏蔽无权查看的视频(如充电专属视频)'.tr
        : '仅对首页 app 端推荐生效，请先切换为App端推荐或合并模式'.tr,
  ...
  SwitchModel(
    title: '已关注UP豁免推荐过滤'.tr,
    subtitle: '推荐中已关注用户发布的内容不会被过滤'.tr,
  ...
  SwitchModel(
    title: '过滤器也应用于详情页相关视频'.tr,
    subtitle: '其它（如热门视频、搜索等）均不受过滤器影响，无法豁免相关视频中的已关注UP'.tr,
  ...
  SwitchModel(
    title: '过滤器也应用于热门视频'.tr,
    subtitle: '开启后对热门视频应用完整过滤（标题关键词、时长、播放量、点赞率、屏蔽用户）'.tr,
  ...
  SwitchModel(
    title: '过滤器也应用于分区视频'.tr,
    subtitle: '开启后对 UGC 分区视频应用完整过滤；番剧等 PGC 内容仅过滤标题关键词'.tr,
  ...
  SwitchModel(
    title: '过滤器也应用于搜索结果'.tr,
    subtitle: '对视频、专栏、用户搜索生效，仅过滤标题关键词和屏蔽用户'.tr,
  ...
  WidgetModel(
    searchTitle: '推荐过滤说明'.tr,
    searchSubtitle: '手动搜索、链接跳转不受过滤器影响'.tr,
    child: Builder(
      builder: (context) {
