  ...
  Widget loginByQRCode(ThemeData theme) {
    return Column(
      children: [
        ...
        Text('使用 bilibili 官方 App 扫码登录'.tr),
        const SizedBox(height: 20),
        Obx(
          () => Text(
        ...
        Row(
          ...
          children: [
            ...
            TextButton.icon(
              onPressed: () async {
                SmartDialog.showLoading(msg: '正在生成截图'.tr);
                final boundary =
          ...
          () {
            ...
            return GestureDetector(
              onTap: () => Utils.copyText(
                url,
                toastText: '已复制到剪贴板，可粘贴至已登录的app私信处发送，然后点击已发送的链接打开'.tr,
              ),
              child: Padding(
                  ...
                  child: TabBar(
                    ...
                    tabs: [
                      Tab(
                        child: Row(
                          mainAxisSize: MainAxisSize.min,
                          children: [Icon(Icons.password), Text(' 密码'.tr)],
                        ),
                      ),
                      Tab(
                        child: Row(
                          mainAxisSize: MainAxisSize.min,
                          children: [Icon(Icons.sms_outlined), Text(' 短信'.tr)],
                        ),
                      ),
                      Tab(
                        child: Row(
                          mainAxisSize: MainAxisSize.min,
                          children: [Icon(Icons.qr_code), Text(' 扫码'.tr)],
                        ),
                      ),
                      Tab(
                        child: Row(
      ...
      body: Column(
        children: [
          if (!isLandscape)
            TabBar(
              tabs: [
                Tab(icon: Icon(Icons.password), text: '密码'.tr),
                Tab(icon: Icon(Icons.sms_outlined), text: '短信'.tr),
                Tab(icon: Icon(Icons.qr_code), text: '扫码'.tr),
