            ...
            return [
              if (isOwner) ...[
                ...
                PopupMenuItem(
                  ...
                  child: Text('${folderInfo.favState == 1 ? '取消' : ''}收藏'.tr),
                ),
  ...
  List<Widget> _selectActions(ThemeData theme) {
    ...
    return [
      ...
      TextButton(
        ...
        child: Text('复制'.tr, style: textStyle),
      ),
      TextButton(
        style: btnStyle,
        onPressed: () => RequestUtils.onCopyOrMove<FavDetailItemModel>(
        ...
        child: Text('移动'.tr, style: textStyle),
      ),
      TextButton(
        style: btnStyle,
                ...
                itemBuilder: (context, index) {
                  if (index == response.length) {
                    ...
                    return Container(
                      ...
                      child: Text(
                        _favDetailController.isEnd ? '没有更多了'.tr : '加载中...'.tr,
                        style: TextStyle(
                          color: theme.colorScheme.outline,
                          fontSize: 13,
                        ),
