...
class _SharePanelState extends State<SharePanel> {
                  ...
                  child: SizedBox(
                    ...
                    child: Column(
                      children: [
                        ...
                        const SizedBox(height: 2),
                        Text('更多'.tr, style: TextStyle(fontSize: 12)),
                      ],
                    ),
                  ),
                ),
  ...
  Future<void> _onSend() async {
    ...
    if (list.isEmpty) {
      SmartDialog.showToast('请选择分享的用户'.tr);
      return;
    }
    ...
    if (res.every((e) => e)) {
      Get.back();
      SmartDialog.showToast('分享成功'.tr);
    } else if (res.every((e) => !e)) {
      SmartDialog.showToast('分享失败'.tr);
    } else {
      SmartDialog.showToast('部分分享失败'.tr);
    }
  }
}
